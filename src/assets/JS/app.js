(function () {
 ...
 let theToggle = document.querySelector('.toggle_mnu');
 let mainMenu = document.querySelector('.main-mnu');
...
mainMenu.classList.add('mainMenuNone');
theToggle.addEventListener('click', function events() {
  
  if (theToggle.classList.contains('on')) {
    mainMenu.classList.add('mainMenuShow');
    mainMenu.classList.remove('mainMenuNone');
  
  } else {
    mainMenu.classList.remove('mainMenuShow');
    mainMenu.classList.add('mainMenuNone');
  }
